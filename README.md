...
> 让 AI 成为你的编程搭档，探索 AI 应用开发的无限可能

## 🎯 项目简介

本仓库是一个系统化的 Vibe-Coding（AI 辅助编程）学习框架，旨在帮助开发者掌握如何利用大语言模型（LLM）构建智能应用。
...
│   └── core_concepts.md      # AI 核心概念详解（RAG、Function Call、MCP、Skill）
├── practice/                 # 实践项目模块
│   ├── level1_basic/         # 入门级项目
│   ├── level2_intermediate/  # 进阶级项目
│   └── level3_advanced/      # 高级项目
├── resources/                # 学习资源
│   ├── career_development.md # 职业发展指南
│   └── role_transition.md    # 岗位转型路径指南
...
| 年份 | 阶段 | 特点 |
|:---:|:---:|:---|
| **2023** | 探索期 | 没有岗位，没有应用落地 |
| **2024** | 发展期 | 岗位出现，需求上升 |
| **2025** | 爆发期 | AI 产品经理岗位彻底爆发 |
...
| 岗位 | 薪资范围 |
|:---|:---:|
| AI 解决方案（国内/海外） | 50-70K·15薪 |
| 解决方案架构师（教育） | 50-80K·16薪 |

### 职场变化趋势
- **AI 替代设计环节**：大中厂用 AI 产出原型图
- **产品经理需要转型**：尽快补足 AI 知识
- **其他岗位尽早转型**：寻找与 AI 结合的机会

📚 详细内容请参考：
- [职业发展指南](resources/career_development.md)
- [岗位转型路径指南](resources/role_transition.md)
...
📚 详细解释请参考：[AI 核心概念详解](theory/core_concepts.md)
